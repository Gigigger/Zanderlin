	...
	if(master.grid)
		...
		if(islist(numerical_display_contents))
			for(var/index in numerical_display_contents)
				...
				screen_x = copytext_char_char(screen_loc, 1, findtext(screen_loc, ","))
				screen_pixel_x = text2num(copytext_char_char(screen_x, findtext(screen_x, ":") + 1))
				screen_pixel_x += (world.icon_size/2)*((used_gridwidth/world.icon_size)-1)
				screen_x = text2num(copytext_char_char(screen_x, 1, findtext(screen_x, ":")))
				screen_y = copytext_char_char(screen_loc, findtext(screen_loc, ",") + 1)
				screen_pixel_y = text2num(copytext_char_char(screen_y, findtext(screen_y, ":") + 1))
				screen_pixel_y += (world.icon_size/2)*((used_gridheight/world.icon_size)-1)
				screen_y = text2num(copytext_char_char(screen_y, 1, findtext(screen_y, ":")))
...
/datum/component/storage/proc/screen_loc_to_grid_coordinates(screen_loc = "")
	if(!grid)
		return FALSE
	var/screen_x = copytext_char_char(screen_loc, 1, findtext(screen_loc, ","))
	var/screen_pixel_x = text2num(copytext_char_char(screen_x, findtext(screen_x, ":") + 1))
	screen_x = text2num(copytext_char_char(screen_x, 1, findtext(screen_x, ":")))

	var/screen_y = copytext_char_char(screen_loc, findtext(screen_loc, ",") + 1)
	var/screen_pixel_y = text2num(copytext_char_char(screen_y, findtext(screen_y, ":") + 1))
	screen_y = text2num(copytext_char_char(screen_y, 1, findtext(screen_y, ":")))
...
/datum/component/storage/proc/grid_coordinates_to_screen_loc(coordinates = "")
	...
	var/coordinate_x = copytext_char_char(coordinates, 1, findtext(coordinates, ","))
	coordinate_x = text2num(copytext_char_char(coordinate_x, 1, findtext(coordinate_x, ":")))

	var/coordinate_y = copytext_char_char(coordinates, findtext(coordinates, ",") + 1)
	coordinate_y = text2num(copytext_char_char(coordinate_y, 1, findtext(coordinate_y, ":")))
...
/datum/component/storage/proc/validate_grid_coordinates(coordinates = "", grid_width = 1, grid_height = 1, obj/item/dragged_item)
	...
	var/screen_x = copytext_char_char(coordinates, 1, findtext(coordinates, ","))
	screen_x = text2num(copytext_char_char(screen_x, 1, findtext(screen_x, ":")))
	var/screen_y = copytext_char_char(coordinates, findtext(coordinates, ",") + 1)
	screen_y = text2num(copytext_char_char(screen_y, 1, findtext(screen_y, ":")))
...
/datum/component/storage/proc/grid_add_item(obj/item/storing, coordinates)
	...
	var/coordinate_x = text2num(copytext_char_char(coordinates, 1, findtext(coordinates, ",")))
	var/coordinate_y = text2num(copytext_char_char(coordinates, findtext(coordinates, ",") + 1))
