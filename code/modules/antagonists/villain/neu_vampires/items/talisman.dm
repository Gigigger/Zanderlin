...
/obj/item/talisman/examine(mob/user)
	. = ..()
	if (blood_text)
		user << browse("<HTML><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY text = #612014>[blood_text]</BODY></HTML>", "window = [name]")
		onclose(user, "[name]")
		return
