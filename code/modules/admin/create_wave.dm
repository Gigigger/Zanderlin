...
/datum/create_wave/proc/create_job(mob/admin)
    ...
    // Generate HTML form
	var/dat = {"
	<html><meta charset='UTF-8'><head><title>Create Custom Job</title></head><body>
...
/datum/create_wave/proc/edit_job(mob/admin, datum/job/custom_job/J)
    ...
    // Generate HTML form
	var/dat = {"
	<html><meta charset='UTF-8'><head><title>Edit Custom Wave</title></head><body>
...
/datum/create_wave/proc/create_wave(mob/admin)
    ...
    // Generate HTML form
	var/dat = {"
	<html><meta charset='UTF-8'><head><title>Create Custom Wave</title></head><body>
	<form name='wave' action='byond://?src=[REF(src)];[HrefToken()]' method='get'>
	<input type='hidden' name='src' value='[REF(src)]'>
	[HrefTokenFormField()]
