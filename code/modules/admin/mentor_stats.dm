/proc/get_mentor_stats(key)
	if(!key)
		return
	var/json_file = file("data/player_saves/[copytext_char_char(key,1,2)]/[key]/mentor_stats.json")
...
/proc/check_mentor_stats_menu(ckey)
	if(!fexists("data/player_saves/[copytext_char_char(ckey,1,2)]/[ckey]/mentor_stats.json"))
