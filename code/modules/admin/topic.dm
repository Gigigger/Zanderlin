...
/datum/admins/Topic(href, href_list)
	...
	if(href_list["editrightsbrowsermanage"])
		...
		var/json_file = file("data/player_saves/[copytext_char_char(the_key,1,2)]/[the_key]/commends.json")
		...
		var/json_file = file("data/player_saves/[copytext_char_char(the_key,1,2)]/[the_key]/curses.json")
		if(!fexists(json_file))
			WRITE_FILE(json_file, "{}")
		var/list/json = json_decode(file2text(json_file))
