...
/obj/item/paper/proc/addtofield(id, text, links = 0)
	...
	if(links)
		var/before = copytext_char_char(info_links, 1, textindex)
		var/after = copytext_char_char(info_links, textindex)
		info_links = before + text + after
	else
		var/before = copytext_char_char(info, 1, textindex)
		var/after = copytext_char_char(info, textindex)
