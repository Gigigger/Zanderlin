...
/proc/invertHTML(HTMLstring)
	...
	var/textr = copytext_char_char(HTMLstring, 2, 4)
	var/textg = copytext_char_char(HTMLstring, 4, 6)
	var/textb = copytext_char_char(HTMLstring, 6, 8)
...
/proc/GUID()
	...
	var/node_id = copytext_char_char(md5("[rand()*rand(1,9999999)][world.name][world.hub][world.hub_password][world.internet_address][world.address][world.contents.len][world.status][world.port][rand()*rand(1,9999999)]"), 1, 13)
